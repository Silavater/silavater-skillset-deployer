...
This repository includes or mirrors content from the following third-party projects for offline and repeatable deployment.
...
- Local path: `vendor/skill-sources/mattpocock-skills`
- Local license file: `vendor/skill-sources/mattpocock-skills/LICENSE`

## affaan-m/ECC

- Source: https://github.com/affaan-m/ECC
- License: MIT
- Copyright notice: Copyright (c) 2026 Affaan Mustafa
...
本 repository 包含或鏡像下列第三方專案內容，以支援離線且可重複的部署。
...
- 授權：MIT
- Copyright notice：Copyright (c) 2026 Matt Pocock
- 本機路徑：`vendor/skill-sources/mattpocock-skills`
- 本機授權檔：`vendor/skill-sources/mattpocock-skills/LICENSE`
